...
class DetailPage extends StatelessWidget {
  ...
  Widget _buildStatsRow() {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        _buildStatBox(Icons.star, destinasi['rating'].toString(), 'Rating', Colors.orange),
        _buildStatBox(Icons.location_on, '${destinasi['jarak_km']} km', 'Jarak', Colors.green),
  ...
  Widget _buildVisitInfoSection() {
    return Column(
      ...
      children: [
        ...
        _buildInfoRow(Icons.access_time, 'Jam Buka', 'Senin - Minggu: 05.00 - 21.00'),
        _buildInfoRow(Icons.attach_money, 'Tiket Masuk', 'Gratis'),
        _buildInfoRow(Icons.checkroom, 'Dress Code', 'Berpakaian sopan dan menutup aurat'),
        _buildInfoRow(Icons.location_on_outlined, 'Alamat', 'Jl. Sisingamangaraja, Medan Kota, Medan'),
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Row(
                    children: List.generate(5, (i) => const Icon(Icons.star, color: Colors.orange, size: 14)),
                  ),
                ],
              ),
            ],
    ...
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            flex: 2,
            child: _buildActionBtn(context, Icons.smart_toy_outlined, 'AI Guide', true),
          ),
          const SizedBox(width: 8),
          Expanded(
            flex: 2,
            child: _buildActionBtn(context, Icons.hotel_outlined, 'Hotel Dekat', true),
          ),
          const SizedBox(width: 8),
          Expanded(
            flex: 3,
  ...
  Widget _buildActionBtn(BuildContext context, IconData icon, String label, bool isOutline) {
    return OutlinedButton(
      onPressed: () {
        if (label == 'Hotel Dekat') {
          // Navigate to hotel page by popping back to Home and switching tab
